...
3. **74 Tests** ohne Panel, ohne Datenbank, ohne Spielserver:
   - `tests/PhaseTest.php` (38) – die Neustart-Logik. Vor allem: wann *nicht* neu gestartet wird.
   - `tests/InstallTest.php` (36) – Aufbau-Erkennung an echten Paketen, Abhängigkeiten, Kompatibilitätshinweise.
